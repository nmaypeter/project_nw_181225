...
class SeedSelectionNG:
    ...
    def updateExpectProfitList(self, s_set, nb_seed_set, ep_list, cur_bud, a_n_set, w_list, pp_list):
        ...
        for k in range(self.num_product):
            for i in nb_seed_set[k]:
                ep_list[k][int(i)] = dnic_u.getSeedExpectProfit(k, i, s_set, a_n_set[k], w_list, pp_list[k])
...
if __name__ == "__main__":
    ...
    ssng = SeedSelectionNG(graph_dict, seed_cost_dict, product_list, total_budget, pps, whether_passing_information_without_purchasing)
    dnic = DiffusionNormalIC(graph_dict, seed_cost_dict, product_list, pps, whether_passing_information_without_purchasing)
